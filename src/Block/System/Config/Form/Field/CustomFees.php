...
class CustomFees extends AbstractFieldArray
{
    ...
    {
        // TODO: Add logic to instantiate the Advanced Modal renderer block with the trigger button ID, row ID and other data
        //$row->setData('advanced', $this->getLayout()->createBlock(Advanced::class));
    }
