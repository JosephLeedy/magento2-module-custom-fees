...
class EnableConfiguredCustomFees implements DataPatchInterface
{
    ...
    {
        $this->configUpdater->addFieldToDefaultCustomFees('status', '1', 'value');
        ...
        array_walk(
            ...
            function (string $storeCode): void {
                $this->configUpdater->addFieldToCustomFeesByStore($storeCode, 'status', '1', 'value');
            },
        );
