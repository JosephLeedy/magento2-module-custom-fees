...
final class TotalsTest extends TestCase
{
    ...
    #[DataFixture('JosephLeedy_CustomFees::../test/Integration/_files/order_with_custom_fees_discounted.php')]
    public function testInitializesInvoicedCustomFeeTotalsWithDiscounts(): void
    {
        $objectManager = Bootstrap::getObjectManager();
        /** @var Order $order */
        $order = $objectManager->create(Order::class);
