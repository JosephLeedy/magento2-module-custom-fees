...
final class CsvTest extends AbstractBackendController
{
    protected $resource = CustomOrderFees::ADMIN_RESOURCE;
    protected $uri = 'backend/custom_fees/report/customOrderFees_export_csv';

    public function testExportsReportAsCsv(): void
    {
