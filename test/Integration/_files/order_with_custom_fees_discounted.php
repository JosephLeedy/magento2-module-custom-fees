...
$order
    ->setBaseDiscountAmount($order->getBaseDiscountAmount() + 0.65)
    ->setDiscountAmount($order->getDiscountAmount() + 0.65)
    ->setBaseGrandTotal($order->getBaseGrandTotal() + 5.85)
    ->setGrandTotal($order->getGrandTotal() + 5.85)
